...
public class MenuPrincipal extends JFrame {
    ...
    private void registrarCarrera() {
        ...
        int codigo = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el código de la carrera:"));
        int semestres = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de semestres:"));

        // Validaciones de la carrera
        if (nombre.isEmpty() || codigo <= 0 || semestres <= 0) {
            JOptionPane.showMessageDialog(this, "Datos de carrera inválidos. Por favor, inténtelo de nuevo.");
            return;
        }

        Carrera nuevaCarrera = new Carrera(nombre, codigo, semestres);
    ...
    private void registrarEstudiante() {
        ...
        String numMatricula = JOptionPane.showInputDialog("Ingrese el número de matrícula:");
        ...
        Estudiante nuevoEstudiante = new Estudiante(nombre, rut, numMatricula);
